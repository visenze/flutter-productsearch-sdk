...
- [visenze_productsearch_sdk](#visenze_productsearch_sdk)
  ...
  - [4. Advanced search](#4-advanced-search)
    - [4.1 Automatic object detection](#4-advanced-search)
    - [4.2 Filters and text filters](#4-filters-and-text-filters)
    - [4.3 Facets](#4-facets)
    - [4.4 Attributes retrieval](#4-attributes-retrieval)
  - [5. Search results](#4-search-results)
  - [6. Event tracking](#5-event-tracking)
    - [6.1 Set up](#5.1-set-up)
    - [6.2 Send events](#5.2-send-events)
    - [6.3 Event parameters](#5.3-event-parameters)
